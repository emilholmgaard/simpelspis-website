...
export default async function RecipePage({
  ...
  return (
    <>
      ...
      />
      <main className="relative overflow-hidden min-h-screen bg-white dark:bg-gray-950">
      ...
      <div
        aria-hidden="true"
        className="absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80 no-print"
      >
        <div
          style={{
            clipPath:
      ...
      <div
        aria-hidden="true"
        className="absolute inset-x-0 top-[calc(100%-13rem)] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[calc(100%-30rem)] no-print"
      >
        <div
          style={{
            clipPath:
      ...
      <Container className="mt-12 pb-24 print:mt-0 relative z-10">
        {/* Breadcrumbs */}
        ...
        <div className="max-w-7xl">
          ...
          <div className="flex flex-wrap items-center gap-4">
            <SaveRecipe recipeSlug={slug} recipeTitle={recipe.title} />
